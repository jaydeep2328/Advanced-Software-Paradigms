<%if(null != session.getAttribute("userdtls")){ %>
...
<!-- MENU SECTION END-->
    ...
    <div class="row">
    	<div class="col-md-3">
    	<jsp:include page="/jsp/normalusers/leftmenu.jsp"></jsp:include>
    	</div>
    	<div class="col-md-9">
        <jsp:include page="/jsp/normalusers/${filename }.jsp" />
        </div>
    </div>
    </div>
